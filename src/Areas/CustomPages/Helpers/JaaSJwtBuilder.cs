...
namespace Weavy.Areas.CustomPages.Helpers
{
    ...
    class JaaSJwtBuilder
    {
        ...
        /// <summary>
        /// Reads a RSA private key PKCS#1 format from file.
        ...
        public static RSA ReadPrivateKeyFromFile(String privateKeyFilePath)
        {
            var certFile = new X509Certificate2(privateKeyFilePath, "", X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);

            return certFile.GetRSAPrivateKey();
        }
    }
}